...
def populate_map(
    ...
    **kwargs,
    ...
    date = "2025-22nd-October " # adjustable date that appears on figure
...
def create_map(
    ...
    **kwargs,
    ...
    if save:
        ...
        ddate = "2025-10-22 (plot date)"       #data.time.dt.strftime("%Y_%m_%d").values // folder name
        fdate = "2025-10-22"                    # file name 
